...
<div class="p-4">
    ...
    @csrf
    <div class="mt-1">
        <textarea name="tweet" class="focus:ring-blue-400 focus:border-blue-400 mt-1 block w-full sm:text-sm border boredr-gray-300 rounded-md p-2" rows="3" placeholder="つぶやきを入力"></textarea>
    </div>
